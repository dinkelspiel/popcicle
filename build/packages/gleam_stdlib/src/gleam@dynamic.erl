...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 103).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 116).
-spec classify(dynamic_()) -> binary().
classify(Data) ->
    gleam_stdlib:classify_dynamic(Data).

-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 133).
-spec int(dynamic_()) -> {ok, integer()} | {error, list(decode_error())}.
int(Data) ->
    gleam_stdlib:decode_int(Data).

-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 156).
-spec float(dynamic_()) -> {ok, float()} | {error, list(decode_error())}.
float(Data) ->
    gleam_stdlib:decode_float(Data).

-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 179).
-spec bool(dynamic_()) -> {ok, boolean()} | {error, list(decode_error())}.
bool(Data) ->
    gleam_stdlib:decode_bool(Data).

-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 205).
-spec shallow_list(dynamic_()) -> {ok, list(dynamic_())} |
    {error, list(decode_error())}.
shallow_list(Value) ->
    gleam_stdlib:decode_list(Value).

-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 348).
-spec optional(fun((dynamic_()) -> {ok, CJW} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        gleam@option:option(CJW)} |
    {error, list(decode_error())}).
optional(Decode) ->
    fun(Value) -> gleam_stdlib:decode_option(Value, Decode) end.

-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 483).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 1013).
-spec any(list(fun((dynamic_()) -> {ok, CNW} | {error, list(decode_error())}))) -> fun((dynamic_()) -> {ok,
        CNW} |
    {error, list(decode_error())}).
any(Decoders) ->
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 1509).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 1046).
-spec decode1(
    fun((COA) -> COB),
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 555).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 236).
-spec result(
    fun((dynamic_()) -> {ok, CJE} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CJG} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {ok, CJE} | {error, CJG}} |
    {error, list(decode_error())}).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 293).
-spec list(fun((dynamic_()) -> {ok, CJR} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        list(CJR)} |
    {error, list(decode_error())}).
list(Decoder_type) ->
    fun(Dynamic) ->
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 96).
-spec map_errors(
    {ok, CIH} | {error, list(decode_error())},
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 84).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 377).
-spec field(
    any(),
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 419).
-spec optional_field(
    any(),
    fun((dynamic_()) -> {ok, CKK} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@option:option(CKK)} |
    {error, list(decode_error())}).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 462).
-spec element(
    integer(),
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 545).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 621).
-spec tuple2(
    fun((dynamic_()) -> {ok, CLS} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CLU} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {CLS, CLU}} | {error, list(decode_error())}).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 690).
-spec tuple3(
...
) -> fun((dynamic_()) -> {ok, {CLX, CLZ, CMB}} | {error, list(decode_error())}).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 761).
-spec tuple4(
...
) -> fun((dynamic_()) -> {ok, {CME, CMG, CMI, CMK}} |
    {error, list(decode_error())}).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 834).
-spec tuple5(
    ...
    fun((dynamic_()) -> {ok, CMV} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {CMN, CMP, CMR, CMT, CMV}} |
    {error, list(decode_error())}).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 909).
-spec tuple6(
...
) -> fun((dynamic_()) -> {ok, {CMY, CNA, CNC, CNE, CNG, CNI}} |
    {error, list(decode_error())}).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 960).
-spec dict(
    fun((dynamic_()) -> {ok, CNL} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CNN} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@dict:dict(CNL, CNN)} |
    {error, list(decode_error())}).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 1074).
-spec decode2(
    fun((COE, COF) -> COG),
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 1106).
-spec decode3(
    fun((COK, COL, COM) -> CON),
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 1152).
-spec decode4(
    fun((COS, COT, COU, COV) -> COW),
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 1208).
-spec decode5(
    fun((CPC, CPD, CPE, CPF, CPG) -> CPH),
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 1268).
-spec decode6(
    fun((CPO, CPP, CPQ, CPR, CPS, CPT) -> CPU),
    ...
    fun((dynamic_()) -> {ok, CPR} | {error, list(decode_error())}),
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 1333).
-spec decode7(
    fun((CQC, CQD, CQE, CQF, CQG, CQH, CQI) -> CQJ),
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 1402).
-spec decode8(
    fun((CQS, CQT, CQU, CQV, CQW, CQX, CQY, CQZ) -> CRA),
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 1475).
-spec decode9(
    fun((CRK, CRL, CRM, CRN, CRO, CRP, CRQ, CRR, CRS) -> CRT),
